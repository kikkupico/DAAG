...
- **Claims board / cut-off tent.** Both are about answering as one. But one states the rule for
  the Anchor's board and the other proves it cannot be kept while birds are lost. Different
