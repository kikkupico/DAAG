...
which comes to **23 buildings for 31 papers** — two of them structural, carrying no paper at
...
| **The three courts** | Castro &amp; Liskov 1999 | Three successive courtyards on the acropolis. A decree passes from the first to the second only when two-thirds of those present have echoed it, and to the third on the same terms — so any two courts share an honest voice, in an assembly of 3f + 1 where f may lie, including the one on the stage. |
